        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl">
                    ...
                    <form id="edit-form" method="POST" action="{{ route('shortlink.update') }}">
                        @csrf

                        <input type="hidden" name="shortlink_id" value="{{$data->id}}"/>    
                        <!-- Link -->
                        <div>
                            <div class="relative mb-3" data-te-input-wrapper-init>
                                <textarea id='big_link'
                                    ...
                                    name='big_link'>{{$data->link}}</textarea>
                                <!-- <label
                        ...
                        <div>
                            <div>Your Short Link is : <span id="slink">{{$data->shortlink}}</span></div>
                        </div><br>
    ...
    <script>
        $(document).ready(function(){
            ...
            $(".postbutton").click(function(event){
                ...
                if(isValidURL($("#big_link").val()) === true){
                    $('#edit-form').submit();
                } else {
